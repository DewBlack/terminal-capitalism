...
# Mirror alineado con configuracion runtime.
...
const WEEKLY_ACTIVITY_NOTIONAL_FLOOR := RUN_BALANCE_CONFIG.WEEKLY_ACTIVITY_NOTIONAL_FLOOR
const WEEKLY_ACTIVITY_NOTIONAL_RATIO := RUN_BALANCE_CONFIG.WEEKLY_ACTIVITY_NOTIONAL_RATIO
const WEEKLY_LOW_ACTIVITY_RATIO := RUN_BALANCE_CONFIG.WEEKLY_LOW_ACTIVITY_RATIO
const MIN_WEEKLY_HOLDINGS_FOR_ACTIVITY := RUN_BALANCE_CONFIG.MIN_WEEKLY_HOLDINGS_FOR_ACTIVITY
const PRICE_DENOMINATION_SCALE := RUN_BALANCE_CONFIG.PRICE_DENOMINATION_SCALE
const PRICE_MIN_FLOOR := RUN_BALANCE_CONFIG.PRICE_MIN_FLOOR
const COMPANY_LISTING_PRICE_FLOOR := RUN_BALANCE_CONFIG.COMPANY_LISTING_PRICE_FLOOR
const NATURAL_BANKRUPTCY_HARD_FLOOR := RUN_BALANCE_CONFIG.NATURAL_BANKRUPTCY_HARD_FLOOR
const NATURAL_BANKRUPTCY_RISK_FLOOR := RUN_BALANCE_CONFIG.NATURAL_BANKRUPTCY_RISK_FLOOR
const NATURAL_BANKRUPTCY_PANIC_FLOOR := RUN_BALANCE_CONFIG.NATURAL_BANKRUPTCY_PANIC_FLOOR
const NEWS_IMPACT_SCALE := RUN_BALANCE_CONFIG.NEWS_IMPACT_SCALE
const MARKET_NOISE_SCALE := RUN_BALANCE_CONFIG.MARKET_NOISE_SCALE
const DAILY_CHANGE_CAP := RUN_BALANCE_CONFIG.DAILY_CHANGE_CAP
const BUY_TRANSACTION_FEE_RATE := RUN_BALANCE_CONFIG.BUY_TRANSACTION_FEE_RATE
const SELL_TRANSACTION_FEE_RATE := RUN_BALANCE_CONFIG.SELL_TRANSACTION_FEE_RATE
const INTRADAY_EXIT_PENALTY_RATE := RUN_BALANCE_CONFIG.INTRADAY_EXIT_PENALTY_RATE
const DEBT_DEFEAT_THRESHOLD := RUN_OUTCOME_SERVICE.DEBT_DEFEAT_THRESHOLD
...
func _process_weekly_economy(strategy_state: Dictionary, market_manager: MarketManager, current_day: int) -> void:
	...
	if not grace_week:
		if not traded_this_week:
			...
			inactivity_surcharge = INACTIVITY_WEEKLY_SURCHARGE
	inactivity_surcharge *= RUN_BALANCE_CONFIG.weekly_surcharge_multiplier(week_index)
